...
in
{
  ...
  options = {
    myDevices = lib.mkOption {
      description = "A globally accessible list of my devices.";
      type = lib.types.listOf lib.types.str;
      default = builtins.attrNames (
        lib.attrsets.filterAttrs (name: value: value == "directory") (builtins.readDir ./devices)
      );
    };
  };
  config = {
