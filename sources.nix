rec {
  ...
  homeManager26_05Src = builtins.fetchTarball
    "https://github.com/nix-community/home-manager/archive/refs/heads/release-26.05.zip";
  homeManager25_05 = import "${homeManager25_05Src}/nixos";
  homeManager25_11 = import "${homeManager25_11Src}/nixos";
  homeManager26_05 = import "${homeManager26_05Src}/nixos";
  nixpkgs25_05 = import (
